...
----
--
. In the `src/main/resources/org/acme/kogito` folder, use the {PRODUCT} BPMN designer in VSCode to open the `PersonProcess.bpmn2` process diagram that you created.
