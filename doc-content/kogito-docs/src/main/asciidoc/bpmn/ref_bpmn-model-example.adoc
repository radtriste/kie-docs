[id='ref_bpmn-model-example_{context}']
= BPMN model example
...
Based on these processes and on application configurations, {PRODUCT} generates a set of REST operations to create new orders, to list and delete active orders, and to determine the age of any given person.
