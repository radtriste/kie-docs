[id='proc_bpmn-model-creating_{context}']
...
+
NOTE: For a new BPMN file, you can also enter `bpmn.new` in a Google Chrome browser to design your business process in the {PRODUCT} online BPMN designer. When you finish creating your process, you can click *Download* in the online designer page to import your BPMN file into your {PRODUCT} project.
...
The following are additional BPMN models that are used with the `Person` process as part of the same example application:
...
For more {PRODUCT} examples and instructions for using them, see the https://github.com/kiegroup/kogito-examples[kogito-examples] page in GitHub.
--
