[id='proc_task-lifecycle-custom_{context}']
...
* https://github.com/kiegroup/kogito-examples/tree/master/kogito-usertasks-custom-lifecycle-quarkus[`kogito-usertasks-custom-lifecycle-quarkus`]: Example on Quarkus
* https://github.com/kiegroup/kogito-examples/tree/master/kogito-usertasks-custom-lifecycle-springboot[`kogito-usertasks-custom-lifecycle-springboot`]: Example on Spring Boot
