...
* https://github.com/kiegroup/kogito-quickstarts/tree/master/kogito-kafka-quickstart-quarkus[`kogito-kafka-quickstart-quarkus`]: Example on Quarkus
* https://github.com/kiegroup/kogito-quickstarts/tree/master/kogito-kafka-quickstart-quarkus[`kogito-kafka-quickstart-springboot`]: Example on Spring Boot
